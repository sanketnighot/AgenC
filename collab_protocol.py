...
ROLES: dict[str, CollaborationRole] = {
    "data": CollaborationRole(
        ...
        memory_reads=("research_summary", "strategy_brief", "sentiment_score", "fear_greed_value", "yield_opportunities"),
    ...
    "sentiment": CollaborationRole(
        ...
        memory_reads=("eth_price", "market_summary", "defi_tvl_data", "yield_opportunities"),
        artifact_producer=False,
        lead_candidate=True,
        non_lead_delay_sec=0.0,
    ),
    "yield": CollaborationRole(
        memory_writes=(
            "yield_opportunities",
            "best_apy_pools",
            "risk_assessment",
        ...
        memory_reads=("eth_price", "market_summary", "sentiment_score", "fear_greed_value"),
        artifact_producer=False,
        lead_candidate=True,
        non_lead_delay_sec=0.0,
    ),
